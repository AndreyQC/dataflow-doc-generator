...
object:
  ...
  object_key: pg_database/ScoreManager_DB/schema/mentor/type/view/name/vw_subtask_log
  object_name: vw_subtask_log
...
CREATE VIEW mentor.vw_subtask_log AS
 SELECT stl.subtask_log_id,
    c.course_id,
...
ALTER VIEW mentor.vw_subtask_log OWNER TO bi_admin;
